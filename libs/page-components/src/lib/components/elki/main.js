    ...
    <Card>
      <Card.Body>
          ...
          <Col>
            <ButtonGroup toggle className="mb-2" style={{ float: 'right' }}>
              <ToggleButton
                ...
                value={1}
                checked={1 === active}
                onChange={() => switchActive(1)}
                variant={active === 1 ? 'info' : 'secondary'}
              >
                Gracze
              </ToggleButton>
              <ToggleButton
                ...
                value={2}
                checked={2 === active}
                onChange={() => switchActive(2)}
                variant={active === 2 ? 'info' : 'secondary'}
              >
                Eliksiry
              </ToggleButton>
            </ButtonGroup>
        ...
        <Table
          ...
          hover
          variant="dark"
          className={active === 1 ? '' : 'toggle-visible'}
        >
          <thead>
            <tr>
              <th>#</th>
        ...
        <Table
          ...
          hover
          variant="dark"
          className={active === 2 ? '' : 'toggle-visible'}
        >
          <thead>
            <tr>
              <th>#</th>
