            ...
            <Card.Body>
              <Card.Title>
                <Col>
                  <h3
                    style={{
                      color: `#${accent(elkiInfo[e.eliksir].hex).normal}`,
                    }}
                  >
                    {' '}
                    {e.id}{' '}
              ...
              >
                <Badge
                  ...
                  variant={e.weryfikowane == 1 ? 'success' : 'danger'}
                >
                  Weryfikowany
                </Badge>
                <Badge
                  style={{ marginRight: '5px' }}
                  variant={e.odebrane == 1 ? 'success' : 'danger'}
                  className={e.odebrane == 1 ? 'hoverContainer' : ''}
                >
                  Odebrane
                  {e.odebrane == 1 ? (
                    <span className="hoverText">
                      {formatDate(e.data_odebrania) || 'Brak daty odebrania'}
                    </span>
                  ) : (
                    ''
                  )}
                ...
                <Badge style={{ marginRight: '5px' }} variant="warning">
                  Cena <Badge variant="light">{e.cena}</Badge>
                </Badge>
                <Badge style={{ marginRight: '5px' }} variant="secondary">
                  Ile{' '}
                  <Badge variant="light">
                    {e.pile || elkiInfo[e.eliksir].ile}
                  </Badge>
                </Badge>
                <Badge style={{ marginRight: '5px' }} variant="secondary">
                  Ważność{' '}
                  <Badge variant="light">
                    {e.pdata || elkiInfo[e.eliksir].data}
                  </Badge>
                </Badge>
              </div>
              ...
              >
                <OverlayTrigger
                  ...
                  overlay={
                    <Popover>
                      ...
                      <Popover.Content>
                        <p>
                          <strong>Kolor:</strong> {elkiInfo[e.eliksir].kolor}
                        </p>
                        <p>
                          <strong>Smak:</strong> {elkiInfo[e.eliksir].smak}
                        </p>
                        <p>
                          <strong>Zapach:</strong> {elkiInfo[e.eliksir].zapach}
                        </p>
                        <p>
                          <strong>Trwa:</strong>{' '}
                          {isNaN(elkiInfo[e.eliksir].czas)
                            ? elkiInfo[e.eliksir].czas
                            : elkiInfo[e.eliksir].czas / 60 ==
                              elkiInfo[e.eliksir].czas / 60
                            ? elkiInfo[e.eliksir].czas / 60 + ' godzin'
                            : (elkiInfo[e.eliksir].czas / 60).toPrecision(2) +
                              ' godzin'}
                        </p>
                        <p>
                          <strong>Inokreacja:</strong>{' '}
                          {elkiInfo[e.eliksir].inokreacja}
                        </p>
                      </Popover.Content>
                    </Popover>
                  }
                >
                  ...
                  >
                    <path
                      style={{ fill: '#E0E0E2' }}
                      d="M442.947,294.957c-10.17-68.812-56.721-125.591-120.164-149.374V33.391h16.327
                    ...
                    <path
                      style={{
                        fill: `#${accent(elkiInfo[e.eliksir].hex).lighter}`,
                      }}
                      d="M69.053,294.957c-1.346,9.106-2.271,18.346-2.271,27.826C66.783,427.284,151.497,512,256,512
                                            s189.217-84.716,189.217-189.217c0-9.48-0.925-18.72-2.271-27.826H69.053z"
                    />
                    <path
                      style={{
                        fill: `#${accent(elkiInfo[e.eliksir].hex).light}`,
                      }}
                      d="M256,294.957V512c104.501,0,189.217-84.716,189.217-189.217c0-9.48-0.925-18.72-2.271-27.826H256z"
                    />
                    <circle
                      style={{
                        fill: `#${accent(elkiInfo[e.eliksir].hex).normal}`,
                      }}
                      cx="283.459"
                      cy="395.13"
                      r="50.087"
                    ...
                    <circle
                      style={{
                        fill: `#${accent(elkiInfo[e.eliksir].hex).dark}`,
                      }}
                      cx="250.067"
                      cy="228.174"
                      r="16.696"
