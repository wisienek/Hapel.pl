        ...
        <Container className="profileContainer">
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <div id="userName" className="centerFlex">
                ...
                {sUser.hasPerms == true ? (
                  <OverlayTrigger
                    placement="auto"
                    overlay={<Tooltip>Moderator</Tooltip>}
                  >
                    <Badge id="modBadge" className="profileBadge">
                      {' '}
                      <FaBolt />{' '}
                    </Badge>
                  </OverlayTrigger>
                  ...
                  <OverlayTrigger
                    placement="auto"
                    overlay={<Tooltip>Profesor</Tooltip>}
                  >
                    <Badge id="teachBadge" className="profileBadge">
                      {' '}
                      <FaChalkboardTeacher />{' '}
                    </Badge>
                  </OverlayTrigger>
              ...
              <p>
                Dołączono{' '}
                {!sUser.created ? '------' : sUser.created.replace(/T.*/g, '')}
              </p>
            </div>
          </div>
          ...
          <div className="profileControlls">
            {loading == false ? (
              <OverlayTrigger
                placement="left"
                overlay={<Tooltip> Odśwież informacje </Tooltip>}
              >
              ...
              <OverlayTrigger
                placement="left"
                overlay={<Tooltip> Ładuję informacje </Tooltip>}
              >
            ...
            {searched.length > 0 ? (
              ...
              <OverlayTrigger
                placement="auto"
                overlay={<Tooltip> Wyloguj </Tooltip>}
              >
