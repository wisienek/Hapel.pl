        ...
        <Card className="mainPageDiscords" key={`dc-${ind}`}>
          ...
          >
            <div className="discordInvite">
              <img
                src={`https://cdn.discordapp.com/icons/${inf.id}/${inf.guild.icon}.webp?size=64`}
              ...
              <div>
                ...
                <div className="onlineWrapper">
                  ...
                  ></i>
                  <span>Online: {inf.approximate_presence_count}</span>
                  <i
                    style={{
                      display: 'block',
                      borderRadius: '50%',
                  ...
                  ></i>
                  <span>Graczy: {inf.approximate_member_count}</span>
                </div>
              </div>
            </div>
            <div
