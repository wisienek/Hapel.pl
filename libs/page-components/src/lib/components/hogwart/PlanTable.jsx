            ...
            <ListGroup.Item key={'lekcja' + ind}>
              <OverlayTrigger
                ...
                overlay={
                  <Popover>
                    <Popover.Title as="h5">
                      {lek?.Sprof?.nick || lek.prof.nick}
                    </Popover.Title>
                    <Popover.Content>
                      <p>
                        <strong>Nazwisko: </strong>{' '}
                        {lek?.Sprof?.displayName || lek.prof.displayName}{' '}
                      </p>
                      <p>
                        ...
                        <Link
                          style={{ color: '#c5c9c5' }}
                          to={`/user/${
                            lek?.Sprof?.discord || lek.prof.discord
                          }`}
                          target="_blank"
                        >
                          {' '}
              ...
              >
                <img
                  id={`profh-${lek?.Sprof?.nick || lek.prof.nick}${ind}`}
                  src={`https://minotar.net/helm/${
                    lek?.Sprof?.nick || lek.prof.nick
                  }/64.png`}
                  alt={lek?.Sprof?.nick || lek.prof.nick}
              ...
              <div className="lessonControlls">
                {lek.when &&
                (lek.Sprof || lek.Sstart || lek.Send || lek.Splace) ? (
                  <OverlayTrigger
                    placement="auto"
                    trigger={['hover', 'focus']}
                    overlay={
                      <Popover>
                        ...
                        <Popover.Content>
                          {lek.Sprof ? (
                            <p>
                              <strong>Profesor: </strong> {lek.prof.nick}{' '}
                              <GoArrowRight /> {lek.Sprof.nick}{' '}
                            </p>
                          ) : (
                            ''
                          )}
                          {lek.Sstart ? (
                            <p>
                              <strong>Start: </strong> {lek.start}{' '}
                              <GoArrowRight /> {lek.Sstart}{' '}
                            </p>
                          ) : (
                            ''
                          )}
                          {lek.Send ? (
                            <p>
                              <strong>Koniec: </strong> {lek.end}{' '}
                              <GoArrowRight /> {lek.Send}{' '}
                            </p>
                          ) : (
                            ''
                          )}
                          {lek.Splace ? (
                            <p>
                              <strong>Miejsce: </strong> {lek.place}{' '}
                              <GoArrowRight /> {lek.Splace}{' '}
                            </p>
                          ) : (
                            ''
                          )}
                          <p>
                            <strong>Do Kiedy: </strong> {lek.when}{' '}
                          </p>
                        </Popover.Content>
                      </Popover>
                    }
