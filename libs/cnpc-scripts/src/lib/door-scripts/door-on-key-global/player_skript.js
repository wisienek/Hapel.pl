function interact(e) {
  ...
  if (
    e.type == 0 &&
    e.target.getName().indexOf('minecraft') &&
    (e.target.getName().indexOf('door') || e.target.getName().indexOf('chest'))
  ) {
    ...
    if (mainh.getDisplayName().toLowerCase() == '§akluczyk') {
      if (zamek && zamek['claim'] == 'claimed') {
        if (
          mainh.getLore()[0].toLowerCase().indexOf('oryginalny kluczyk') ==
            -1 &&
          mainh.getLore()[0].toLowerCase().indexOf('podrabiany kluczyk') == -1
        ) {
      ...
      if (
        mainh.getLore()[0].indexOf('Dobrej jakości') == -1 &&
        mainh.getLore()[0].indexOf('Słabej jakości') == -1 &&
        mainh.getLore()[0].indexOf('Magiczny') == -1
      ) {
        e.setCanceled(true);
        return e.player.message(
          '§f§l[§cWytrych§f] Twój wytrych wygląda jakoś dziwnie'
        );
      }
      if (zamek && zamek['claim'] == 'claimed') {
        if (zamek['lvl']) {
          ...
          if (wytrych(zamek['lvl']) == false) {
            ...
            if (Number(mainh.getLore()[1]) == 1) {
              mainh.setStackSize(mainh.getStackSize() - 1);
            } else {
              mainh.setLore([
                mainh.getLore()[0],
                Number(mainh.getLore()[1]) - 1,
              ]);
            }
      ...
      if (zamek && zamek['lvl']) {
        if (zamek['lvl'] > Number(mainh.getLore()[0].split(':'))) {
          return e.player.message(
            '§f§l[§cKłudka§f] Nie można dać mniejszej kłudki na większą'
          );
        }
      }
