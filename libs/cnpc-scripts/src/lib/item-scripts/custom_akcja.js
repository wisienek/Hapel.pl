var lista = [
  [
    "§e**W kąciku ust Harry'ego zebrała się spora ilość śliny, która po chwili popłynęła mu po podbródku, §eaż na koszulkę,",
  ...
  if (data) {
    ...
    if ((d2 - d1) / 60000 < 5) {
      return e.player.message(
        '[§cAkcje§f] §7Możesz wysyłać akcje co 5min. (zostało ' +
          (5 - (d2 - d1) / 60000).toFixed(2) +
          ')'
      );
    } else {
