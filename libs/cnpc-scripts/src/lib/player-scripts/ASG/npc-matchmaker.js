function dialogOption(e){
    ...
    switch(opt){
        ...
        case 2:{
            //max-ppl
            if(mainh.getName()=="air"){return e.player.message("Nic nie trzymasz!!")}
            ...
            if(lore.length>0){
                ...
                return e.player.message("Musisz trzymać item z opisem. W pierwszej linijce musi być liczba osób");
            }
        }
        case 3:{
            //max-score to win
            ...
            if(lore.length>0){
                ...
                return e.player.message("Musisz trzymać item z opisem. W pierwszej linijce musi być liczba punktów");
            }
        }
        case 4:{
            //start match
        ...
        default: e.player.message("Nic nie wybrano");
    }
}
