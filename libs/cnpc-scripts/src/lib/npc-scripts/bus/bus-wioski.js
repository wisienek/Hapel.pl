var wioski = ["Londyn", "Hogsmeade", "River Heights", "Spinners end", "Dolina Godryka", "Little Hangleton"];
...
function interact(e){
    if(e.player.isSneaking()){return e.player.message("return")}
    var lore = e.item.getLore();
    var data = e.player.world.getStoreddata();
    if(!lore[0]){return e.player.message("Nie ma lore[0]")}
