...
var URL = Java.type("java.net.URL"),
    ...
    HTTP = {
        get: function (e, t) {
            ...
            a.setRequestMethod("GET"), a.setRequestProperty("User-Agent", "Mozilla/5.0");
            for (var r, n = a.getResponseCode(), p = new BufferedReader(new InputStreamReader(a.getInputStream())), o = ""; null != (r = p.readLine());) o = o + r + "\n";
        ...
        post: function (e, t) {
            var a, r, n = new URL(e).openConnection();
            n.setDoInput(!0), n.setDoOutput(!0), n.setInstanceFollowRedirects(!1), n.setRequestMethod("POST"), n.setRequestProperty("Content-Type", "application/json; utf-8"), n.setRequestProperty("User-Agent", "Mozilla/5.0");
            try {
                a = n.getOutputStream();
                var p = new DataOutputStream(a);
                p.writeBytes(new String(JSON.stringify(t))), p.flush(), p.close(), a.close()
            } catch (e) {}
            var o = null;
            try {
                r = new BufferedReader(new InputStreamReader(n.getInputStream(), "UTF-8"));
...
function ang(e) {
    return e = e.replace(/ą/g, "a").replace(/Ą/g, "A").replace(/ć/g, "c").replace(/Ć/g, "C").replace(/ę/g, "e").replace(/Ę/g, "E").replace(/ł/g, "l").replace(/Ł/g, "L").replace(/ń/g, "n").replace(/Ń/g, "N").replace(/ó/g, "o").replace(/Ó/g, "O").replace(/ś/g, "s").replace(/Ś/g, "S").replace(/ż/g, "z").replace(/Ż/g, "Z").replace(/ź/g, "z").replace(/Ź/g, "Z").replace(/§/g, "&")
}
...
function customGuiSlot(e) {
    ...
    if (e.slotId >= 6 && e.slotId <= 11) {
        id = e.slotId - 6
    } else
    if (e.slotId >= 12 && e.slotId <= 17) {
        id = e.slotId - 12
    } else
    if (e.slotId >= 18 && e.slotId <= 23) {
        id = e.slotId - 12
    } else
    if (e.slotId >= 24 && e.slotId <= 29) {
        id = e.slotId - 18
    } else
    if (e.slotId >= 30 && e.slotId <= 35) {
        id = e.slotId - 24
    } else
    if (e.slotId >= 36 && e.slotId <= 41) {
        id = e.slotId - 24
    } else
    if (e.slotId >= 42 && e.slotId <= 47) {
        id = e.slotId - 30
    } else
    if (e.slotId >= 48 && e.slotId <= 53) {
        id = e.slotId - 36
    }
