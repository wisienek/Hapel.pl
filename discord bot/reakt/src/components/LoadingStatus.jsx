...
import loadingGContext, { loadingContext } from "./LoadingContext";

const LoadingStatus = () => {
    const [ loadingG, setLoadingG ] = useContext( loadingContext );

    return (
        <div id="loadingG" style={ loadingG == true? { opacity: "1" }: { opacity: "0", zIndex: "-200"} }>
            <svg id="wrap" style={{ width: "300px", height: "300px" }}>
                <svg>
