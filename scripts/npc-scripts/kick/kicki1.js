...
function interact(e){
    ...
    if(e.player.hasActiveQuest(8)){
        ...
        if(v==0){
            ...
            e.player.world.broadcast("[§cZając§f] §b"+e.player.getName()+"§7 Złapał szczęśliwego zajączka!");
            e.player.message("[§cZając§f] §7Zanieś go spowrotem do jajcarza aby odebrać nagrodę!");
        }else{
