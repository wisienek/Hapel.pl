...
function init(e){
    ...
    e.item.setLore(["§bGwizdek Stefana","§eLPM:§r Zmienia opcje","§cPPM:§r Gwiżdże","§7Opcja 1: Powiadamia o niebezpieczeństwie","§7Opcja 2: Powiadamia o chęci wejścia"]);
    opt=0;
}
...
function interact(e){
    ...
    var bpos = [[89,90,83],[9,119,243],[24,82,473]];
    var sblok;
    var dist;
    for(var x in bpos){
