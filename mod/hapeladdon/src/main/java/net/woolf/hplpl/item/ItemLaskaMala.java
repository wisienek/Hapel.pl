...
public class ItemLaskaMala extends ElementsHapeladdons.ModElement {
	@GameRegistry.ObjectHolder("hapeladdons:laskamala")
	public static final Item block = null;
	public ItemLaskaMala(ElementsHapeladdons instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("hapeladdons:laskamala", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(12);
			maxStackSize = 1;
			setUnlocalizedName("laskamala");
			setRegistryName("laskamala");
