...
public class ItemLaska extends ElementsHapeladdons.ModElement {
	@GameRegistry.ObjectHolder("hapeladdons:laska")
	public static final Item block = null;
	public ItemLaska(ElementsHapeladdons instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("hapeladdons:laska", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("laska");
			setRegistryName("laska");
