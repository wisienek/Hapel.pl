...
public class EntityNiffler extends ElementsHapeladdons.ModElement {
	public static final int ENTITYID = 13;
	public static final int ENTITYID_RANGED = 14;
	public EntityNiffler(ElementsHapeladdons instance) {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hapeladdons", "niffler"), ENTITYID).name("niffler").tracker(64, 3, true).egg(-1, -1).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelniffler(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hapeladdons:textures/niffler.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityCreature{
		...
		protected void initEntityAI() {
			...
			this.tasks.addTask(4, new EntityAIPanic(this, 0.7));
			this.tasks.addTask(5, new EntityAIEatGrass(this));
			this.tasks.addTask(6, new EntityAITempt(this, 0.8, new ItemStack(Items.GOLD_INGOT, (int) (1)).getItem(), false));
			this.tasks.addTask(7, new EntityAIFollow(this, (float) 0.6, 10, 5));
		}
	...
	public static class Modelniffler extends ModelBase {
		...
		public Modelniffler() {
			...
			Tors.addChild(Glowa);
			Glowa.cubeList.add(new ModelBox(Glowa, 31, 22, -3.0F, -1.8F, -5.0F, 7, 4, 7, 0.0F, false));
			...
			szyja.cubeList.add(new ModelBox(szyja, 0, 29, -4.0F, -3.4855F, -6.1301F, 8, 6, 8, 0.0F, false));
			brzuchsrodek = new ModelRenderer(this);
			brzuchsrodek.setRotationPoint(-1.0F, -10.6F, 5.2F);
			Tors.addChild(brzuchsrodek);
			brzuchsrodek.cubeList.add(new ModelBox(brzuchsrodek, 0, 15, -4.0F, -2.3767F, -6.3829F, 10, 5, 9, 0.0F, false));
			...
			brzuchpodstawa.cubeList.add(new ModelBox(brzuchpodstawa, 0, 0, -5.0F, -3.7607F, -7.3709F, 10, 6, 9, 0.0F, false));
			...
			Brzuchpodstawa2.cubeList.add(new ModelBox(Brzuchpodstawa2, 30, 7, -3.0F, -2.4168F, -5.6922F, 8, 3, 8, 0.0F, false));
		...
		public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
			...
			this.LewaLapaGora.rotateAngleX = MathHelper.cos(f * 1.0F) * -1.0F * f1;
			this.DUPA.rotateAngleY = MathHelper.cos(f * 1.0F) * -1.0F * f1;
			this.LewaLapaDol.rotateAngleX = MathHelper.cos(f * 1.0F) * -1.0F * f1;
			this.PrawaLapaGora.rotateAngleX = MathHelper.cos(f * 1.0F) * 1.0F * f1;
			this.PrawaLapaDol.rotateAngleX = MathHelper.cos(f * 1.0F) * 1.0F * f1;
		}
	}
}
